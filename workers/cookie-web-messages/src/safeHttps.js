...
// timing-dependent DNS-rebinding gap: fetch() re-resolves independently, so a
// domain a determined attacker can re-point between our check and fetch()'s
// own resolution could still slip through. Accepted trade-off — see the
// cookie-web-messages Worker's PR description for the alternatives
// considered.
